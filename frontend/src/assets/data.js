...
export const getBlogs = (t) => [
  { title: t("blogs.1.title"), category: t("categories.men"), image: blog1 },
  { title: t("blogs.2.title"), category: t("categories.women"), image: blog2 },
  { title: t("blogs.3.title"), category: t("categories.kids"), image: blog3 },
  { title: t("blogs.4.title"), category: t("categories.topwear"), image: blog4 }
];
